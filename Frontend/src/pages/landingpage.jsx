        ...
        <div className="max-w-screen-2xl container mx-auto ms:px-20 px-4 flex flex-col md:flex-row">
          <div className="w-full md:w-1/2 mt-12 md:mt32">
            <div className="space-y-20">
              <h1 className="mt-10 text-4xl front-bold">
                Hello, Welcome here to learn something{" "}
                <span className="text-pink-500">new everyday!!!</span>
              </h1>
              <p className="text-xl">
                Discover literary treasures at our bookstore, from bestsellers
                to timeless classics. Enjoy personalized recommendations,
                exclusive discounts, and fast delivery, making your next great
                read just a click away.
                <span className="text-pink-500">
                  <br />
                  <br />
                  Love reading books...YOU ARE AT RIGHT PLACE!!!
                </span>
              </p>
          ...
          <div className="w-full md:w-1/2">
            <img
              src={banner}
              className="h-45 w-45 hidden md:block"
              alt="banner"
            />
          </div>
        </div>
